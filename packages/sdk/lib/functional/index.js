    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, !!connection.simulate
                    ...
                    : PlainFetcher_1.PlainFetcher.fetch(connection, __assign(__assign({}, getHello.METADATA), { path: getHello.path() }))];
        });
    });
}
...
(function (getHello) {
    ...
    getHello.simulate = function (connection) {
        return getHello.random("object" === typeof connection.simulate && null !== connection.simulate
            ? connection.simulate
            : undefined);
    };
